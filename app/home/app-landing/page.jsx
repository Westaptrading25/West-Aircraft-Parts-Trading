  ...
  return (
    <>
      ...
      <div className="fancy-feature-seven">
          ...
          <div className="row align-items-center">
            <div className="col-xl-6 col-lg-5" data-aos="fade-right">
              <div className="title-style-four text-center text-lg-start">
                <h2 className="main-title fw-500 tx-dark m0">
                  Welcome to West <span>Aircraft</span> Parts Trading
                </h2>
              </div>
              {/* /.title-style-four */}
            </div>
            ...
            <div className="col-lg-6 ms-auto" data-aos="fade-left">
              <p className="text-lg text-center text-lg-start md-pt-30 m0">
                At West Aircraft Parts Trading, we are dedicated to providing
                top-quality aircraft parts and exceptional maintenance services.
                With years of industry experience, our team of experts ensures
                that every component meets the highest standards of safety and
                reliability. Whether you need routine maintenance, specialized
                repairs, or hard-to-find parts, we have you covered. Our
                commitment to excellence and customer satisfaction sets us apart
                as a trusted partner in aviation.
              </p>
            </div>
            {/* End .col-6 */}
          </div>
        ...
        <div className="container pt-50 lg-pt-10" id="s2">
      ...
      <div className="fancy-feature-eight position-relative mt-225 xl-mt-150 md-mt-100">
        ...
        <div className="illustration-holder">
          <img
            src="/images/aircraft/aircraft.svg"
            alt="media"
            className="lazy-img main-img"
          />
          <img
            src="/images/aircraft/hangar.svg"
            alt="media"
      ...
      {/* 
        ...
        */}
      <div
        className="fancy-feature-nine position-relative pt-250 lg-pt-130"
        id="s3"
      >
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-5">
              <div className="block-style-three" data-data-aos="fade-right">
                <div className="title-style-four">
                  ...
                  <h2 className="main-title fw-500 tx-dark m0">
                    Why you choose West Aircraft parts <span>Trading </span>
                  </h2>
                </div>
                {/* /.title-style-four */}
                <p className="fs-20 pt-45 pe-xxl-5">
                  Aircraft parts trading offers a strategic approach to managing
                  aviation assets, ensuring operational efficiency,
          ...
          <div className="row">
            <div className="col-lg-6 col-md-8 m-auto">
              ...
              >
                ...
                <h2 className="main-title fw-500 tx-dark m0">
                  Check key features of our <span>Services</span>
                </h2>
              </div>
              {/* /.title-style-four */}
            </div>
      ...
      {/*
        ...
        =====================================================
        */}
      <div className="fancy-short-banner-four position-relative" id="s5">
        <div className="container">
          <div className="row">
            ...
            <div className="col-xxl-8 col-xl-9 col-md-9 m-auto text-center">
              <div className="title-style-four" data-aos="fade-up">
                <h2 className="main-title fw-500 text-white m0">
                  Take Flight with Us Today! For further information and
                  support, please <span>contact us.</span>
                </h2>
              </div>
              {/* /.title-style-four */}
              <p
                ...
                data-data-aos="fade-up"
              >
                Send Us a Message! We’d love to hear from you and will get back
                to you shortly.
              </p>
              {/* <Subsribe /> */}
            ...
            <div className="row">
              {/* <div className="col-lg-4">
                <div className="logo d-flex justify-content-center justify-content-lg-start">
                  <Link href="/">
                    <img src="/images/aircraft/logo.png" alt="" width={77} />
                  </Link>
                </div>
              </div> */}
              {/* End .col-lg-4 */}

              <div className="col-lg-6 text-center md-mt-30 md-mb-30">
